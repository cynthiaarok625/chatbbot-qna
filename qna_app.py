...
import asyncio
from qna_maker import QnaBot
#rom qnabot import QnaBot

app = Flask(__name__)
loop = asyncio.get_event_loop()

botsettings = BotFrameworkAdapterSettings("35f4a300-68e1-4790-a4dd-20df5ed8f13e","WPfyR?kTC3(9JuBw6[Y)PP4)BW")
